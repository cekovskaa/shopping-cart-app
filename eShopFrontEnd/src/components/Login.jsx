...
const Login = () => {
    ...
    const handleLogin = async () => {
        ...
        try {
            const response = await axios.post("https://localhost:44317/api/User/Login", {
                username,
                password,
            });
            ...
            const tokenExpDate = response.data.expiresAt;

            document.cookie = `auth=${jwtToken}`;
            document.cookie = `expdate=${tokenExpDate};`
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
            <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
                <h1 className="font-bold text-center text-2xl mb-5">Sign in to your account</h1>
